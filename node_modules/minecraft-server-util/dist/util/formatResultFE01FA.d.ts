 ...
 */
declare function formatResultFE01FA(host: string, port: number, srvRecord: SRVRecord | null, protocolVersion: number, version: string, motd: string, onlinePlayers: number, maxPlayers: number): StatusResponse;
