...
module.exports = {
    ...
    description: 'This SS command sets the rules channel for the server. The new rules channel can be identified with a icon that shows a book with a tick on it',
